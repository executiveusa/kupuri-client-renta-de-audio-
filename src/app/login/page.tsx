...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault()
    setLoading(true)
    // Auth logic will be implemented with NextAuth
        ...
        <section className="w-full max-w-md px-4 md:px-8 py-20">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-text-secondary">Sign in to your Kupuri Audio account</p>
            </div>
            ...
            <div className="mt-8 p-4 bg-bg-dark rounded-lg border border-primary/20">
              <p className="text-xs text-text-secondary mb-2">
                <span className="font-semibold text-primary">Demo Mode:</span> Use any email with password <code className="text-accent font-mono">kupuri2026</code>
              </p>
            </div>
          </motion.div>
        </section>
